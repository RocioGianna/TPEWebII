       ...
       /* const tipoUsuario = document.getElementById("tipo_usuario").textContent;
        ...
        for(let coment of comentarios){
           // if(!tipoUsuario){
                ...
                <button type="submit" id="deleteCom" class="btn btn-secondary btnDelete"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
